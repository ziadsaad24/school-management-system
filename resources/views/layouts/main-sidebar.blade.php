                  ...
                  <li>
                    ...
                    <li>
                        ...
                        <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                            ...
                            <li> <a href="{{ route('receipt_students.index') }}">{{ trans('Fees_trans.receipt_vouchers') }}</a> </li>
                            <li> <a href="{{ route('ProcessingFee.index') }}">{{ trans('Fees_trans.processing_fees') }}</a> </li>
                            <li> <a href="{{ route('Payment_students.index') }}">{{ trans('Fees_trans.payment_vouchers') }}</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Attendance-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route('Attendance.index') }}">قائمه الطلاب</a> </li>
