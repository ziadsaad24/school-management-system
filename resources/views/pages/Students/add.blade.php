...
<div class="row">
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                {{-- Fallback: render php-flasher envelopes as Bootstrap alerts so the user always sees messages even if toastr fails --}}
...
@section('js')
    @toastr_js
    @toastr_render
    {{-- Fallback: show session success message if toastr not configured --}}
