                                    ...
                                    <table id="datatable" class="table table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($fees as $fee)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('Fees.edit', $fee->id) }}" class="btn btn-info btn-sm" role="button" aria-pressed="true" title="{{ trans('fees_trans.edit') }}">
