    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{ trans('Fees_trans.delete_processing') }}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('ProcessingFee.destroy','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{ trans('Fees_trans.confirm_delete') }}</h5>
